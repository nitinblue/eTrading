...
AGENT_REGISTRY: dict[str, dict] = {
    ...
    'maverick': {
        ...
        'category': 'domain',
        'role': 'Trading orchestration — ranking → gates → trade proposals',
        'intro': 'I consume Scout rankings, apply portfolio/risk gates, and produce trade proposals ready for WhatIf booking.',
        'description': 'Domain orchestrator: consumes rankings, enforces portfolio gates, proposes and books WhatIf trades.',
        'responsibilities': ['Consume Scout rankings', 'Portfolio-level gate checks', 'Risk-level gate checks', 'Trade proposal generation', 'Duplicate prevention', 'WhatIf trade booking', 'Decision tracking'],
        'datasources': ["context['ranking'] (from Scout)", "context['screening_candidates'] (from Scout)", 'PortfolioBundle (via ContainerManager)', 'ResearchContainer (via ContainerManager)'],
        'boundaries': ['LIMIT orders only', 'Defined-risk strategies only for WhatIf', 'Cannot override risk limits'],
        'runs_during': ['booting', 'monitoring'],
    },
    'atlas': {
